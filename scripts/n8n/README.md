...
> la siguiente, y había que pedir el cambio a mano — o se publicaba 9:16 en el feed, que Instagram
> recorta. Ahora, con `pieza_id` y sin `formato`, hereda el de la última revisión de esa pieza; si
> el pedido lo declara, manda el pedido; y una pieza nueva sin formato sigue siendo `feed`.
