...
from handlers import correccion, propuesta, revision, brief, landing, bibliotecario, campania, campania_meta, pauta_sync, secrets_sync, marca_capsula, descubrimiento, estilo_gen, manual_gen, grafica, voz, tarjeta, skill_sync, contexto_sync, campania_propuesta, auditoria, aprendizaje, pieza_chat
...
HANDLERS = {
    ...
    "auditoria": auditoria.handle,
    "aprendizaje": aprendizaje.handle,
    "pieza_chat": pieza_chat.handle,
}
